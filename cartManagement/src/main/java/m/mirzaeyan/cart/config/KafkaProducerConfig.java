...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, NotificationMessage> workUnitsKafkaTemplate() {
        KafkaTemplate<String, NotificationMessage> kafkaTemplate =  new KafkaTemplate<>(producerFactory());
